...
<div class="container">
    <div class="row">
        <div class="col-8 offset-2">
            <h2>Nova Proposta</h2>
            <form action="/proposta/adicionar" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="{{ old('ds_Endereco_Obra') }}" required
                        autocomplete=off>
                </div>
